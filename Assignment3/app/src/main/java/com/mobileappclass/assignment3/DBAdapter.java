...
public class DBAdapter {
    ...
    public static final String KEY_LATITUDE = "favcolour";
    public static final String KEY_LONGITUDE = "studentnum";
    ...
    public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_TIME, KEY_LATITUDE, KEY_LONGITUDE};
    ...
    public long insertRow(String time, String latitude, String longitude) {
		/*
		 * CHANGE 3:
		 */
    ...
    public boolean updateRow(long rowId, String time, String latitude, String longitude) {
        String where = KEY_ROWID + "=" + rowId;
